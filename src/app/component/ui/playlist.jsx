  ...
  return (
    <>
      <div className="flex flex-row justify-between">
        <h1 className=" font-spotify text-2xl mb-2">Dibuat Untuk anda</h1>
        <h1 className=" font-spotify text-sm mb-2">Tampilkan Semua</h1>
      </div>
      <div className="w-full group/swiper">
        ...
        >
          <div className="swiper-button-prev after:content-[''] absolute left-0 z-10 bg-black/70 w-12 h-12 rounded-full flex items-center justify-center cursor-pointer opacity-0 group-hover/swiper:opacity-100 transition-opacity duration-300">
